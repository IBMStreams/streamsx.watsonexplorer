...
public class SearchOperatorTest extends AbstractOperatorTest {
	...
	public void setup() throws Exception {
		super.setup();
		searchResponseJSONStr = new String(Files.readAllBytes(Paths.get("impl/test/resources/responses/search_response_json.txt")));
		searchResponseXMLStr = new String(Files.readAllBytes(Paths.get("impl/test/resources/responses/search_response_xml.txt")));
		searchResponseAtomXMLStr = new String(Files.readAllBytes(Paths.get("impl/test/resources/responses/search_response_atomxml.txt")));
	}
