...
public class WatsonExplorerQueryTest extends AbstractOperatorTest {
	...
	public void setup() throws Exception {
		super.setup();
		wexQueryResponseXMLStr = new String(Files.readAllBytes(Paths.get("impl/test/resources/responses/wexquery_response_greenthread.txt")));
		wexQueryResponsePage1XMLStr = new String(Files.readAllBytes(Paths.get("impl/test/resources/responses/wexquery_response_page1.txt")));
		wexQueryResponsePage2XMLStr = new String(Files.readAllBytes(Paths.get("impl/test/resources/responses/wexquery_response_page2.txt")));
	}
